          ...
          <div style={{
            ...
            <div className="reveal-el" style={{ 
              ...
              <div style={{
                ...
                <img src="/rim 1.jpeg" alt="Karim" style={{
            ...
            <p className="reveal-el" style={{
              ...
              "Selamat ulang tahun yang ke-19 yaa! Semoga di usiamu yang sekarang kamu selalu diberikan kesehatan, kebahagiaan, dan kekuatan untuk menjalani semua hal yang ada di depan. Jangan pernah merasa bahwa kamu nggak cukup baik, kamu lebih kuat dari yang kamu kira. Tetap jadi diri kamu sendiri dan bahagia selalu yaa! 🤍"
            </p>
